...
public class FileManager {
    ...
    public static void listarTodosContatos(String path) {
        try {
            // Lê todos os arquivos no diretório de contatos
            ...
            if (arquivos != null && arquivos.length > 0) {
                ...
                for (File arquivo : arquivos) {
                    ...
                    for (String linha : linhas) {
                        System.out.println(linha);  // Exibe cada linha no arquivo
                    }
                }
            } else {
    ...
    // Método para buscar um contato pelo ID e exibir todas as informações
...
public static void buscarProcesso(int numeroProcesso, String path) {
    ...
    public static void gravarProcesso(Processo processo, String path) throws IOException {
        File dir = new File(path);
        if (!dir.exists()) {
            dir.mkdirs();  // Cria o diretório se não existir
        }
    ...
    // Método para reescrever um contato existente
